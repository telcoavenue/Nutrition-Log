...
public class NutritionLOG extends JFrame
{
	...
	public String FILEname="C:/Nutrition.LOG./2019/February/";
	...
	String [] dirMAP={"C:/Nutrition.LOG./","C:/Nutrition.LOG./2019/","C:/Nutrition.LOG./2019/February/"};
   ...
   programVsion.addMouseListener(new MouseAdapter() 
	...
	JOptionPane.showMessageDialog(null," \n Nutrition Log/Memo/Diary - version 1.00 - \n 02/2019 \n ;-) \n ","INFORMATION MESSAGE",JOptionPane.INFORMATION_MESSAGE);
 ...
 // public String [] menu=new String[]{"Job Advertisment Media","Advertised Organization","Job Title","Job Description","Date Posted","Application Submission Date"};  
	...
	for(int j=0;j<fnTF.length;j++)
	{
		...
		if(i==0)
		{
			...
			//  if(j == 0) // && i<(fnLabel.length-(fnLabel.length-1)) )
			//  {
	...
	//	String fileNAME = hn1 ;
			...
			//	String date=a;
				...
				String sometext=FILEname+fnTF[fnTF.length-fnTF.length].getText()+".Nutrition.LOG."+a+".txt";
	...
	BufferedWriter out = new BufferedWriter(new FileWriter(file));
		...
		out.newLine(); 
			...
			//	{
					...
					out.write(elements[elements.length-elements.length]);
	...
	// reset components
	                         ...
	                         for(int u23=0;u23<fnTF.length;u23++)
				{
		...
		JFrame frame=new JFrame(" Nutrition Log/Memo - version 1.00 - ");
		frame.add(box);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static void main(String [] NutritionLOG)
	{
